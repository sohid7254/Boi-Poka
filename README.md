...
![Screenshot](https://github.com/sohid7254/Boi-Poka/blob/main/src/assets/fullss.png)

---

## 🚀 Live Demo

🔗 [Live Site](https://roaring-hamster-3362fe.netlify.app/)
...
```bash
 ...
 ## Run locally
 ```bash
 git clone https://github.com/sohid7254/Boi-Poka.git
cd book-poka
npm install
npm run dev
```
